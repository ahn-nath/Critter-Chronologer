...
public class PetController {
	...
	/***
	 * If a GET request is received, get all Pets, convert them to PetDTO and return
	 * list
	 ***/
	@GetMapping
	public List<PetDTO> getPets() {
		...
		List<PetDTO> petDTOs = pets.stream().map(pet -> convertPetToDTO(pet)).collect(Collectors.toList());

		return petDTOs;
	}

	/***
	 * If a GET request is received with the owner id, get all Pets associated to
	 * that owner, convert them to PetDTO and return list
	 ***/
